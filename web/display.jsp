...
document.getElementById("myDiv").style.marginLeft="70px";
...
document.getElementById("myDiv2").style.marginLeft="20px";
...
document.getElementById("myDiv3").style.marginLeft="20px";
